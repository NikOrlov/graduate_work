...
class Filmwork(UUIDMixin, TimeStampedMixin):
    ...
    creation_date = models.DateTimeField(
        _("creation_date"), auto_now_add=True, null=True
    )
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                fields=["creation_date", "rating"], name="fw_creation_date_rating_idx"
            ),
...
class PersonFilmwork(UUIDMixin, TimeStampedMixin):
    ...
    role = models.CharField(
        _("Role"), max_length=15, blank=True, choices=RoleType.choices
    )
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=[_("role"), _("person"), _("film_work")],
