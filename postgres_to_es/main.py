    ...
    try:
        ...
        for index_name in index_names:
            ...
            with PostgresConn(db_config=dsn) as pg_conn:
                ...
                upload_complete = app_state.get_state(
                    f"{index_name} upload_complete_at"
                )
...
def upload_data_to_etl(
    ...
    if not last_upload_id:
        ...
        state.set_state(
            f"{index_name} upload_started_at",
...
def find_updated_data(
    ...
    index_name_to_func = {
        "movies": [
            "get_updated_film_works",
            "get_updated_film_works_genre",
            "get_updated_film_works_person",
        ],
