...
class PostgresConn:
    ...
    def __exit__(
        self,
        exception_type: Union[BaseException, None],
...
class PostgresExtractor:
    ...
    def __init__(
        self, connection: psycopg2.extensions.connection, chunk_size: int = 100
    ) -> None:
    ...
    def extract_table_data(
        self, index_name: str, before_date: str, last_upload_id: Union[str, None] = None
    ) -> Iterator:
        params = [before_date]
        ...
        if index_name == "movies":
            ...
            sql += (
                ' GROUP BY "content"."genre"."id" ORDER BY "content"."genre"."id" ASC;'
            )
        else:
