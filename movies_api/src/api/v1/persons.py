...
async def film_details(
    person_id: str, film_service: FilmService = Depends(get_redis_elastic_service)
) -> Person:
    person = await film_service.get_obj_data_by_id(
        obj_id=person_id, elastic_index_name="persons"
    )
