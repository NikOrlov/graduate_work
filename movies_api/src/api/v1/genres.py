...
async def genre_details(
    genre_id: str, film_service: FilmService = Depends(get_redis_elastic_service)
) -> Genre:
    genre = await film_service.get_obj_data_by_id(
        obj_id=genre_id, elastic_index_name="genres"
    )
