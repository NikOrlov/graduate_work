...
GET_ROLES_POSITIVE_DATA = [
    (
        {"email": "test_admin@testadmin.com", "password": "test_admin"},
        {
            ...
            "length": 2,
            "full_return": {"admin": "admin", "user": "user"},
        },
    )
]

GET_ROLES_NEGATIVE_DATA: list = [({}, {"status": HTTPStatus.UNAUTHORIZED})]
...
CREATE_ROLE_POSITIVE_DATA = [
    (
        {"name": "test", "description": "test"},
        {
            "status": HTTPStatus.ACCEPTED,
            "length": 2,
            "full_return": {"name": "test", "description": "test"},
        },
    )
]

CREATE_ROLE_NEGATIVE_DATA = [
    ({"name": "test", "description": "test"}, {"status": HTTPStatus.UNAUTHORIZED})
]

CHANGE_ROLE_POSITIVE_DATA = [
    (
        {
            "auth": {"email": "test_admin@testadmin.com", "password": "test_admin"},
            "json": {"name": "test", "new_name": "test1", "new_description": "test1"},
        },
        {"status": HTTPStatus.ACCEPTED},
    )
]
...
DELETE_ROLE_NEGATIVE_DATA = [({"name": "test1"}, {"status": HTTPStatus.UNAUTHORIZED})]
